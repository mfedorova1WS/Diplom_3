...
class OrderPage(BasePage):
    ...
    @allure.step("Ожидание модального окна заказа и получение номера заказа")
    ...
    @allure.step("Прокрутка до заказа #{order_number}")
    ...
    @allure.step("Открытие модального окна заказа по номеру #{order_number}")
