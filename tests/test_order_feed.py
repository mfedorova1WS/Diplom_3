...
def test_order_modal_opens_from_feed(create_test_user, driver):
...
def test_total_orders_counter_increases(create_test_user, driver):
    email, password, access_token = create_test_user
...
def test_today_orders_counter_increases(create_test_user, driver):
    email, password, access_token = create_test_user
...
def test_order_appears_in_progress(create_test_user, driver):
    email, password, access_token = create_test_user
...
def test_user_order_appears_in_feed_and_history(create_test_user, driver):
    email, password, access_token = create_test_user
